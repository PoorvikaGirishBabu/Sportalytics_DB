...
BEGIN
   ...
   -- Drop the user if it exists and not connected
    ...
    -- Create the user
    EXECUTE IMMEDIATE 'CREATE USER APP_ADMIN IDENTIFIED BY ApplicationAdmin2024#';
    ...
    EXECUTE IMMEDIATE 'GRANT INSERT,UPDATE,DELETE ON dba_users TO APP_ADMIN';
...
EXCEPTION
    WHEN OTHERS THEN
        dbms_output.put_line('User App_Admin exists');
        COMMIT;
END;
/